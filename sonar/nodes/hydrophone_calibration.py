...
class solver():
    ...
    def run_calibration(self):
        ...
        #17.02 % error with these values, average

        #starting values
        x1_orig = 170.75 #in mm  
        x2_orig = 83.6
        y2_orig = 147.65
        x3_orig = 86.75
        y3_orig = 42.4
        ...
        #hydro1: [170.75, 0, 0] hydro2: [83.6, 147.65, 0] hydro3: [86.75, 42.4, -87.55] @5.007 degrees error

        mm_range = 0.08 #mm 5 = +- 2.5
        mm_resolution = 0.01 #mm

        number_of_iterations = mm_range/mm_resolution

        lowest_error = 5.007 #(11.152 or 16.64% error)

        #experimentally gathered
        tstamps = [[0.00, 115.0, 59.0, 61.75], [10.0, 113.5, 42.5, 55.5], [20.0, 108.62, 23.25, 47.38], [30.0, 101.5, 5.5, 38.5],
                    [40.0, 92.5, -12.5, 30.0], [50.0, 77.0, -35.75, 18.5], [60.0, 61.0, -54.38, 7.5],[70.0, 43.5, -70.5, -3.5], 
                    [80.0, 24.5, -84.5, -14.0], [90.0, 3.5, -96.5, -24.5], [100.0, -17.0, -105.62, -34.0],[110.0, -36.88, -111.62, -42.0],
                    [120.0, -55.0, 114.5, -48.5], [130.0, -71.0, -113.0, -53.5], [140.0, -85.5, -108.5, -56.5], [150.0, -97.0, -100.5, -58.0],
                    [160.0, -105.0, -90.5, -57.0], [170.0, -111.0, -77.5, -54.62], [180.0, -113.5, -63.0, -50.88], [190.0, -113.0, -45.62, -45.5],
                    [200.0, -108.0, -27.0, -38.0], [210.0, -100.5, -7.5, -29.0], [220.0, -89.5, 13.25, -18.5], [230.0, -77.25, 32.0, -8.0],
                    [240.0, -62.5, 50.5, 3.12], [250.0, -45.0, 67.5, 15.0],[260.0, -25.5, 83.0, 26.88], [270.0, -6.5, 94.5, 37.0],
                    [280.0, 11.5, 103.38, 45.5], [290.0, 31.0, 110.0, 54.5], [300.0, 50.0, 113.0, 62.0], [310.0, 66.5, 112.5, 67.0],
                    [320.0, 81.0, 107.5, 70.0], [330.0, 93.38, 99.75, 71.0], [340.0, 103.0, 89.5, 70.62],[350.0, 110.5, 76.5, 69.0]]
                        ...
                        for m in range(int(number_of_iterations)+1):
                            ...
                            for n in range(int(number_of_iterations)+1):
                                ...
                                if error < lowest_error:
                                    lowest_error = error                                    
                                    print "lowest_error: %0.3f" % lowest_error
