...
class solver():
    ...
    def run_calibration(self):
        ...
        #starting values
        x1_orig = 148.45  #148.3  #148.7  #170.7  #173.2 #in mm
        x2_orig = 53.25   #53.2   #53.6   #83.6   #86.6
        y2_orig = -165.05 #-164.9 #-164.5 #-165.5 #-150.0
        x3_orig = 66.35   #66.1   #65.6   #71.6   #86.6
        y3_orig = -22.15  #-22.1  #-22.5  #-46.5  #-50.0
        z3_orig = -137.75  #-138.0 #-138.5 #-119.5 #-100.0

        mm_range = 0.25 #mm 5 = +- 2.5
