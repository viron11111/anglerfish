...
class calibrate_mag():
	...
	def min_max(self, data):
		...
		scale = np.array([[1.0854116892924681, -0.011512841089980547, -0.01138615857308545],
			              [-0.011512841089980505, 1.0396888369241797, -0.00733456385143529], 
			              [-0.011386158573085297, -0.00733456385143535, 0.8864165607648682]])

		self.corrected = np.dot([self.x_out, self.y_out, self.z_out],scale) + np.array([0.004194753492600574, 
			                                                                           -0.002145496944101975,
			                                                                            0.014614507124762723])
