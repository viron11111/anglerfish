...
class start_test():
	...
	def arm_thrusters(self):
		...
		for i in range (0,10):
			self.thrust1_pub.publish(0)
			self.thrust2_pub.publish(0)
			self.thrust3_pub.publish(0)
			self.thrust4_pub.publish(0)
			self.thrust5_pub.publish(0)
			self.thrust6_pub.publish(0)
			self.rate.sleep()
	...
	def forward(self):
		...
		if self.thruster == 1:
			self.thrust1_pub.publish(output * 32767.0)
			...
			self.thrust2_pub.publish(output * 32767.0)
			...
			self.thrust3_pub.publish(output * 32767.0)
			...
			self.thrust4_pub.publish(output * 32767.0)
			...
			self.thrust5_pub.publish(output * 32767.0)
			...
			self.thrust6_pub.publish(output * 32767.0)
	...
	def stop_thrusters():
		thrust1_pub = rospy.Publisher('thruster_cmd1', Int16, queue_size=1)
		thrust2_pub = rospy.Publisher('thruster_cmd2', Int16, queue_size=1)
		thrust3_pub = rospy.Publisher('thruster_cmd3', Int16, queue_size=1)
		thrust4_pub = rospy.Publisher('thruster_cmd4', Int16, queue_size=1)
		thrust5_pub = rospy.Publisher('thruster_cmd5', Int16, queue_size=1)
		thrust6_pub = rospy.Publisher('thruster_cmd6', Int16, queue_size=1)

		thrust1_pub.publish(0)
		thrust2_pub.publish(0)
		thrust3_pub.publish(0)
		thrust4_pub.publish(0)
		thrust5_pub.publish(0)
		thrust6_pub.publish(0)
	...
	def __init__(self):
		...
		self.thrust1_pub = rospy.Publisher('thruster_cmd1', Int16, queue_size=1)
		self.thrust2_pub = rospy.Publisher('thruster_cmd2', Int16, queue_size=1)
		self.thrust3_pub = rospy.Publisher('thruster_cmd3', Int16, queue_size=1)
		self.thrust4_pub = rospy.Publisher('thruster_cmd4', Int16, queue_size=1)
		self.thrust5_pub = rospy.Publisher('thruster_cmd5', Int16, queue_size=1)
		self.thrust6_pub = rospy.Publisher('thruster_cmd6', Int16, queue_size=1)
